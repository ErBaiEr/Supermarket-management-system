...
<head>
    ...
    <script>
        function validate(){
            ...
            var url = "/CourseSetting/EmailServlet"
            $.ajax({
                async:true,
        ...
        function jump(){
            window.location.href = "/CourseSetting/login.jsp";
        }
...
<body>
<span id="flag" style="display: none"></span>
                                    ...
                                    <c:if test="${userInfor != null && userInfor.get(0).getGood() != null}">
                                        <c:forEach items="${userInfor}" var="infor">
                                            <li>
                                                ...
                                                <div class="del-icon">
                                                    <a href="/CourseSetting/DelCartServlet?uid=${infor.user.uid}&gid=${infor.good.gid}&path=register.jsp">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="basic-login">
                        ...
                        <form action="/CourseSetting/RegisterServlet" method="post" onsubmit="return validate()">
                            <label for="username">用户名 <span>**</span></label>
                            <input name="username" id="username" type="text" placeholder="请输入用户名..." />
                            <label for="address">常住地 <span></span></label>
                            <input name="address" id="address" type="text" placeholder="请输入常住地..." />
                            <label for="email">需注册的Email账号 <span>**</span></label>
                            <input name="email" id="email" type="text" placeholder="请输入注册Email账号..." />
                            <label for="password">密码 <span>**</span></label>
                            <input name="password" id="password" type="password" placeholder="请输入密码..." />
                            <div class="mt-10"></div>
                            <button type="submit" class="btn theme-btn-2 w-100">立即 注册</button>
                            <div class="or-divide"><span>or</span></div>
                            <button onclick="jump()" type="button" class="btn theme-btn w-100">立即 登录</button>
