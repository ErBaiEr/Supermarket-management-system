                                    ...
                                    <c:if test="${userInfor != null && userInfor.get(0).getGood() != null}">
                                        <c:forEach items="${userInfor}" var="infor">
                                            <li>
                                                ...
                                                <div class="del-icon">
                                                    <a href="/CourseSetting/DelCartServlet?uid=${infor.user.uid}&gid=${infor.good.gid}&path=product.jsp">
...
<main>
                    ...
                    <div class="product-details mb-30">
                        <div class="product-details-title">
                            ...
                            <div class="price details-price pb-30 mb-20">
                                <span class="old-price">￥${good.price}</span>
                            </div>
                        </div>
                        <div class="product-cat mt-30 mb-30">
                            <span>种类:  </span>
                            <a href="#">${good.category}</a>
                        </div>
                        ...
                        <div class="product-details-action">
                            <form action="#">
                                <div class="plus-minus">
                                    <div class="cart-plus-minus"><input id="count" type="text" value="1" /></div>
                                </div>
                                <button id="button" type="button" class="btn">加入购物车</button>
    ...
    <script>
        $(function (){
            $('#button').click(function (){
                var count = $('#count').val();
                var gid = ${good.gid};
                var url = "/CourseSetting/ProductServlet";
                $.ajax({
                    async:false,
                    contentType:'application/x-www-form-urlencoded',
                    data:"count="+count+"&gid="+gid,
                    type:'GET',
                    url:url,
                    success: function (data){
                        window.location.href = "/CourseSetting/AddCartShowServlet";
                    }
                });
    ...
    <%--<%
        List<UserInfor> ui = (List<UserInfor>) request.getSession().getAttribute("userInfor");
        request.getSession().setAttribute("userInfor", ui);
        request.getRequestDispatcher("/AddCartShowServlet").forward(request,response);
    %>--%>
</main>
