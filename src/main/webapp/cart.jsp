...
<head>
    ...
    <script>
        ...
        %>
        function buy(){
            if(<%=userInfor.get(0).getGood() == null%>){
                alert("购物车暂无商品");
                return false;
            }
            return true;
...
<!--头部-->
<header>
    <div class="header-top-area pl-55 pr-55 d-none d-lg-block" style="padding-bottom: 10px;">
                                    ...
                                    <c:if test="${userInfor != null && userInfor.get(0).getGood() != null}">
                                        <c:forEach items="${userInfor}" var="infor">
                                            <li>
                                                ...
                                                <div class="del-icon">
                                                    <a href="/CourseSetting/DelCartServlet?uid=${infor.user.uid}&gid=${infor.good.gid}&path=cart.jsp">
                    ...
                    <form action="#">
                        <div class="table-content table-responsive">
                            ...
                            <c:if test="${userInfor != null && userInfor.get(0).getGood() != null}">
                                <c:forEach items="${userInfor}" var="infor">
                                    <tr>
                                        <td class="product-thumbnail"><a href="#"><img src="${infor.good.picture}"
                                                                                       alt=""></a></td>
                                        <td class="product-name"><a href="#">${infor.good.gname}</a></td>
                                        <td class="product-price"><span class="amount">￥${infor.good.price}</span></td>
                                        <td class="product-quantity">
                                            <div class="cart-plus-minus"><input type="text" value="${infor.num}" /></div>
                                        </td>
                                        <td class="product-subtotal"><span class="amount">
                                            <fmt:formatNumber type="number" value="${infor.num*infor.good.price}" maxFractionDigits="2"></fmt:formatNumber>
                                        </span></td>
                                        <td class="product-remove"><a onclick="c()" href="#"><i class="fa fa-times"></i></a></td>
                                    </tr>

                                    <script>
                                        function c(){
                                            var Dgid = ${infor.good.gid};
                                            var Duid = ${infor.user.uid};
                                            var url = "/CourseSetting/CartServlet";
                                            $.ajax({
                                                async:false,
                                                contentType:'application/x-www-form-urlencoded',
                                                data:"Duid="+Duid+"&Dgid="+Dgid,
                                                type:'GET',
                                                url:url,
                                                success: function (data){
                                                    window.location.href = "/CourseSetting/RefreshToCartServlet";
                                                }
                                            });
                                        }
                                    </script>
                        ...
                        <div class="row">
                            <div class="col-md-5 ml-auto">
                                <div class="cart-page-total">
                                    ...
                                    <a onclick="return buy()" class="btn theme-btn" href="/CourseSetting/CheckoutServlet">立即 购买</a>
                                </div>
                            </div>
                        </div>
                    </form>
